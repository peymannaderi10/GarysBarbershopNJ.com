  ...
  return (
    <footer className="bg-barber-primary text-white pt-16 pb-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-white hover:text-barber-accent transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-white hover:text-barber-accent transition-colors">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-white hover:text-barber-accent transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link to="/reviews" className="text-white hover:text-barber-accent transition-colors">
                  Reviews
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-white hover:text-barber-accent transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-10 pt-8 text-center text-white">
