...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Gary's Barber Shop | Location, Hours & Appointment Booking | Maple Shade, NJ"
        description="Contact Gary's Barber Shop in Maple Shade, NJ. Located at 12 E Main St. Call (856) 414-1015 or book online. Appointment-only Barber Shop with 34+ years experience. Get directions, hours, and FAQ answers."
        keywords="Gary's Barber Shop contact, Maple Shade Barber Shop location, book appointment, (856) 414-1015, 12 E Main St Maple Shade NJ, Barber Shop hours, appointment booking"
          ...
          <div className="flex items-center justify-center h-full">
            <div className="container mx-auto px-4 text-center text-white">
              ...
              <p className="text-xl max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                Get in touch or visit our Barber Shop in Maple Shade, NJ
              </p>
            </div>
          </div>
        </ParallaxSection>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="animate-fade-in-up">
                <div className="bg-white rounded-lg shadow-md overflow-hidden h-full">
                  <iframe 
                    title="Gary's Barber Shop Location"
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-barber-light p-6 rounded-lg">
                ...
                <p className="text-gray-600">
                  Yes, Gary's Barber Shop operates by appointment only. This allows us to provide personalized attention to each client without long wait times. Learn more <a href="/about" className="text-barber-primary hover:underline">about our philosophy</a>.
                </p>
              </div>
